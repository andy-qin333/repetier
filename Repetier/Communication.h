...
#ifdef NANODLP//add by andy
FSTRINGVAR(tNanodlp)
FSTRINGVAR(tComp)
FSTRINGVAR(tWeight)
FSTRINGVAR(tg)
FSTRINGVAR(tLiquidLevel)
FSTRINGVAR(tDoor_Limit)
FSTRINGVAR(tTemperatureAlarmState)	
FSTRINGVAR(tUVLED_PWM)


FSTRINGVAR(tFound)
FSTRINGVAR(ttags)
FSTRINGVAR(tSens_Response)
FSTRINGVAR(tSel_Response)

FSTRINGVAR(tsens_res)
FSTRINGVAR(t0x)
FSTRINGVAR(tReading)
FSTRINGVAR(tversiondata1)
FSTRINGVAR(tTrough_Resin_Type)
FSTRINGVAR(tRead_card)
...
//static void printFLN(FSTRINGPARAM(text),int value,HEX);//add by andy
//static void printFLN(FSTRINGPARAM(text),int value,DEC);//add by andy
