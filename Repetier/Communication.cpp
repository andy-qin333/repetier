...
FSTRINGVALUE(Com::tComp,"cmd_comp")  //derby.dai
FSTRINGVALUE(Com::tWeight,"Weight:")
FSTRINGVALUE(Com::tg,"g")
FSTRINGVALUE(Com::tLiquidLevel,"Liquid_Level:")
FSTRINGVALUE(Com::tDoor_Limit,"Door_Limit_State:")
FSTRINGVALUE(Com::tTemperatureAlarmState,"Temperature_Alarm_State:")
FSTRINGVALUE(Com::tUVLED_PWM,"UVLED_PWM_VAL:")




FSTRINGVALUE(Com::tFound,"Found")
FSTRINGVALUE(Com::ttags,"tags")
FSTRINGVALUE(Com::tSens_Response,"Sens Response: 0x")
FSTRINGVALUE(Com::tSel_Response,"Sel Response: 0x")

FSTRINGVALUE(Com::tsens_res,"sens_res")
FSTRINGVALUE(Com::t0x,"0x")
FSTRINGVALUE(Com::tReading,"Reading: ")
FSTRINGVALUE(Com::tversiondata1,"versiondata1: ")
FSTRINGVALUE(Com::tTrough_Resin_Type,"Trough_Resin_Type:")
FSTRINGVALUE(Com::tRead_card,"Read card #")
...
FSTRINGVALUE(Com::tEPRPreheatTemp,"Preheat temp. [掳C]")
FSTRINGVALUE(Com::tEPRPreheatBedTemp,"Bed Preheat temp. [掳C]")
