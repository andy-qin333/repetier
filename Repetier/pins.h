...
//add by andy
#define ORIG_PUMP_ENABLE_PIN     9//V1.06//6
#define ORIG_FAN_PIN             7//V1.06//4
//#define ORIG_WATER_PUMP_ENABLE_PIN 8//old fan2
