...
// Multiply two 16 bit values and return 32 bit result
	...
	//add by andy
	    static inline void eprSetDouble(unsigned int pos,double value)
    {
        eeprom_write_block(&value,(void*)(EEPROM_OFFSET + pos), 8);
    }
	//add end
	...
	//add by andy
	  static inline float eprGetDouble(unsigned int pos)
    {
        double v;
        eeprom_read_block(&v,(void *)(EEPROM_OFFSET + pos),8); 
        return v;
    } 
	//add end
