    ...
    function GcodeFilesViewModel(parameters) {
        ...
        self.listHelper = new ItemListHelper(
            ...
            },
            {
                ...
                "local": function(file) {
                    return file["origin"] && file["origin"] == "local";
                },
                "usb": function(file) {
                    return file["origin"] && file["origin"] == "usb";
                },
            ...
            "name",
            [],
            [["sd", "local", "usb"],["machinecode", "model"]],
            0
        );
        ...
        self.loadFile = function(file, printAfterLoad) {
            ...
            $.ajax({
                url: decodeURI(file.refs.resource),
                type: "POST",
                dataType: "json",
        ...
        self.onStartup = function() {
            ...
            self.requestData();
            self.listHelper.toggleFilter('local');
