$(function() {
    function ControlViewModel(parameters) {
        ...
        // zyd for toolNum -s
        self.toolNum = ko.observable("E("+gettext("Tool")+" 0)")
        // zyd for toolNum -e
        
        // zyd for add chamber -s
        self.hasChamber = ko.observable(undefined);
        ...
        self._updateWaterCool = function () {
            if (self.settings.printerProfiles.currentProfileData().heatedChamber()) {
