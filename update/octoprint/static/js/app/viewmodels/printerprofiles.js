$(function() {
    function PrinterProfilesViewModel() {
        ...
        self.editorHeatedChamber = ko.observable(); //zyd for add chamber
        ...
        self.showEditProfileDialog = function(data) {
            ...
            self.editorHeatedChamber(data.heatedChamber); // zyd for add chamber
        ...
        self._editorData = function() {
            ...
            var profile = {
                ...
                heatedChamber: self.editorHeatedChamber(), // zyd for add chamber
                extruder: {
