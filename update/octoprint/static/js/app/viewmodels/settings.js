$(function() {
    function SettingsViewModel(parameters) {
        ...
        // add by evan, for auto-refresh -s
        self.recordlast_language = self.appearance_defaultLanguage;
        // add by evan, for auto-refresh -e
        ...
        self.saveData = function (data, successCallback) {
            ...
            // add by evan, for auto-refresh -s
            //alert("last="+self.recordlast_language+"<->cur="+self.appearance_defaultLanguage());
