...
def printerState():
	...
	if not printerProfileManager.get_current_or_default()["heatedBed"] and not printerProfileManager.get_current_or_default()["heatedChamber"]:
		processor = _delete_bed_and_chamber
