...
def enable_additional_translations(default_locale="en", additional_folders=None):
	...
	def fixed_get_translations():
		...
		if translations is None:
			...
			language = locale.language+("_"+locale.territory if locale.territory is not None else "")
			...
			if language != default_locale:
				...
				for name, plugin in plugins.items():
					...
					for dirname in dirs:
						...
						try:
							plugin_translations = support.Translations.load(dirname, [language])
						except:
				...
				for dirname in dirs:
					core_translations = support.Translations.load(dirname, [language])
