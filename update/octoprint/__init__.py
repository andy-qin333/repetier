...
def main():
	...
	parser.add_argument("-s", "--startLocalServer", action="store", type=str, choices=["true", "false"], dest="sls", 
	                    default="true", help="Specify start localServer with the octoprint(true or false, defaults true)")
